...
namespace MultimediaShop.CoreLogic
{
    public class Engine
    {
        ...
        private void ExecuteRentCommand(IItem item, DateTime rentDate, DateTime deadline)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("There are not enough supplies to sell this item.");
            }
                ...
                case "book":
                    {
                        ...
                        Genre genre = GenreToEnum(itemParams["genre"]);
                ...
                case "game":
                    {
                        ...
                        decimal price = decimal.Parse(itemParams["price"]);
                        Genre genre = GenreToEnum(itemParams["genre"]);
                        Restriction ageRestriction = RestrictionToEnum(itemParams["ageRestriction"]);
        ...
        private static Genre GenreToEnum(string enumString)
        {
            return (Genre)Enum.Parse(typeof(Genre), enumString);
        }

        private static Restriction RestrictionToEnum(string enumString)
        {
            return (Restriction)Enum.Parse(typeof(Restriction), enumString);
        }
